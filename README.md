...
In this lab, you will experiment with machine learning techniques on your own. Please submit a PDF of the screenshots and answers to the "Lab 9: Machine Learning" assignment on Canvas **by Sunday, April 13, 11:59 pm**. If you have any questions, feel free to reach out to the TAs or LAs via email (2.12-lab-staff-s25@mit.edu).
